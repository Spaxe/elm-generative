...
var _creative$elm_generative$Draw$path = function (points) {
...
var _creative$elm_generative$Draw$paths = function (pointsList) {
	return A2(_elm_lang$core$List$map, _creative$elm_generative$Draw$path, pointsList);
};
var _creative$elm_generative$Draw$line = F4(
	function (x1, y1, x2, y2) {
		return _elm_lang$svg$Svg$line(
			{
				ctor: '::',
...
var _creative$elm_generative$Generative$updateSecond = function (f) {
	return _elm_lang$core$List$map(
		_elm_lang$core$Tuple$mapSecond(f));
};
var _creative$elm_generative$Generative$updateFirst = function (f) {
	return _elm_lang$core$List$map(
		_elm_lang$core$Tuple$mapFirst(f));
};
var _creative$elm_generative$Generative$translateList = F3(
	function (x, y, points) {
		return A2(
			_creative$elm_generative$Generative$updateSecond,
			F2(
				function (x, y) {
					return x + y;
				})(y),
			A2(
				_creative$elm_generative$Generative$updateFirst,
				F2(
					function (x, y) {
						return x + y;
					})(x),
...
var _creative$elm_generative$Generative$accumulateTupleList = _elm_community$list_extra$List_Extra$scanl1(
	_elm_lang$core$List$map2(
		F2(
			function (a, b) {
				return {
...
var _creative$elm_generative$Generative$random = function (amplitude) {
	return A2(_elm_lang$core$Random$float, (0 - amplitude) / 2, amplitude / 2);
};
var _creative$elm_generative$Generative$random1D = F2(
	function (n, amplitude) {
		return A2(
			_elm_lang$core$Random$list,
			n,
			_creative$elm_generative$Generative$random(amplitude));
	});
...
var _creative$elm_generative$Example_Curtain$view = function (model) {
	...
	if (_p1.ctor === 'Curtain') {
		return A2(
			...
			{ctor: '[]'},
			_creative$elm_generative$Draw$paths(
				A2(
					_elm_lang$core$List$map,
...
var _creative$elm_generative$Example_Curtain$Empty = {ctor: 'Empty'};
				...
				_1: A2(
					...
					A3(
						...
						A2(
							_elm_lang$core$Random$list,
							100,
							A2(_creative$elm_generative$Generative$random1D, 200, 0.6)),
						A2(
							_elm_lang$core$Random$list,
							100,
							A2(_creative$elm_generative$Generative$random1D, 200, 0.4))))
			};
		} else {
...
var _creative$elm_generative$Example_Curtain$init = A2(_creative$elm_generative$Example_Curtain$update, _creative$elm_generative$Example_Curtain$Generate, _creative$elm_generative$Example_Curtain$Empty);

var _creative$elm_generative$Example_Landscape$numberOfSegments = 1000;
var _creative$elm_generative$Example_Landscape$initialiseLines = function (n) {
	var line = function (y) {
		return A5(_creative$elm_generative$Generative$makePath, _creative$elm_generative$Example_Landscape$numberOfSegments, 10, y, 210, y);
	};
	return A2(
		_elm_lang$core$List$map,
		line,
...
var _creative$elm_generative$Example_Landscape$numberOfLines = 10;
var _creative$elm_generative$Example_Landscape$view = function (model) {
	var _p0 = model;
	var sunSize = 10 + _p0._1;
	var sunPosition = _p0._0;
	var randomValues = A2(_elm_lang$core$List$map, _creative$elm_generative$Generative$accumulate, _p0._2);
	var shepherdedValues = _creative$elm_generative$Generative$accumulateList(randomValues);
	var data = _creative$elm_generative$Example_Landscape$initialiseLines(_creative$elm_generative$Example_Landscape$numberOfLines);
	var transformed = A3(
		_elm_lang$core$List$map2,
		_creative$elm_generative$Generative$map2Second(
			F2(
				...
				_1: A2(
					...
					A4(
						...
						A2(
							...
							_creative$elm_generative$Generative$random(100),
							_creative$elm_generative$Generative$random(50)),
						_creative$elm_generative$Generative$random(10),
						A2(
							_elm_lang$core$Random$list,
							_creative$elm_generative$Example_Landscape$numberOfLines,
							A2(_creative$elm_generative$Generative$random1D, _creative$elm_generative$Example_Landscape$numberOfSegments, 1))))
			};
		} else {
...
var _creative$elm_generative$Example_ParallelRandom$setup = function (n) {
	var line = function (y) {
		return A5(_creative$elm_generative$Generative$makePath, _creative$elm_generative$Example_ParallelRandom$numberOfSegments, 0, y, 110, y);
	};
	return A2(
		_elm_lang$core$List$map,
		line,
			...
			function (_p0) {
				return _elm_lang$core$Basics$toFloat(
					A2(
						...
						_creative$elm_generative$Example_ParallelRandom$gap,
						_p0));
			}));
};
var _creative$elm_generative$Example_ParallelRandom$numberOfLines = 10;
var _creative$elm_generative$Example_ParallelRandom$view = function (model) {
	var randomValues = model;
	var data = _creative$elm_generative$Example_ParallelRandom$setup(_creative$elm_generative$Example_ParallelRandom$numberOfLines);
	var transformed = A3(
		_elm_lang$core$List$map2,
		_creative$elm_generative$Generative$map2Second(
			F2(
	...
	return A2(
		...
		_creative$elm_generative$Draw$paths(
			A2(
				_elm_lang$core$List$map,
				A2(_creative$elm_generative$Generative$translateList, 90, 50),
				transformed)));
};
			...
			return {
				...
				_1: A2(
					...
					A2(
						...
						A2(
							_creative$elm_generative$Generative$random1D,
							_creative$elm_generative$Example_ParallelRandom$numberOfSegments,
							_elm_lang$core$Basics$toFloat(_creative$elm_generative$Example_ParallelRandom$gap))))
			};
		} else {
			return {ctor: '_Tuple2', _0: _p1._0, _1: _elm_lang$core$Platform_Cmd$none};
		}
...
var _creative$elm_generative$Example_Sun$radialLargeRadius = 60;
var _creative$elm_generative$Example_Sun$radialSmallRadius = 25;
var _creative$elm_generative$Example_Sun$numberOfSegments = 128;
var _creative$elm_generative$Example_Sun$initialiseLines = function (n) {
	var line = F2(
		function (_p1, _p0) {
			var _p2 = _p1;
			var _p3 = _p0;
			return A5(_creative$elm_generative$Generative$makePath, _creative$elm_generative$Example_Sun$numberOfSegments, _p2._0, _p2._1, _p3._0, _p3._1);
		});
	return A2(
		_elm_lang$core$List$map,
		function (x) {
			return A2(
				...
				_elm_lang$core$Basics$fromPolar(
					{ctor: '_Tuple2', _0: _creative$elm_generative$Example_Sun$radialSmallRadius, _1: x}),
				_elm_lang$core$Basics$fromPolar(
					{ctor: '_Tuple2', _0: _creative$elm_generative$Example_Sun$radialLargeRadius, _1: x}));
		},
		A2(
			_elm_lang$core$List$map,
			function (x) {
...
var _creative$elm_generative$Example_Sun$numberOfLines = 128;
var _creative$elm_generative$Example_Sun$view = function (model) {
	var _p4 = model;
	if (_p4.ctor === 'Sun') {
		var sunSize = 20 + _p4._0;
		var randomValues = A2(_elm_lang$core$List$map, _creative$elm_generative$Generative$accumulateTuple, _p4._1);
		var shepherdedValues = _creative$elm_generative$Generative$accumulateTupleList(randomValues);
		var data = _creative$elm_generative$Example_Sun$initialiseLines(_creative$elm_generative$Example_Sun$numberOfLines);
		var transformed = A3(
			_elm_lang$core$List$map2,
...
var _creative$elm_generative$Example_Sun$Empty = {ctor: 'Empty'};
			...
			return {
				...
				_1: A2(
					...
					A3(
						...
						_creative$elm_generative$Generative$random(20),
						A2(
							_elm_lang$core$Random$list,
							_creative$elm_generative$Example_Sun$numberOfLines,
							A2(
								_elm_lang$core$Random$list,
								_creative$elm_generative$Example_Sun$numberOfSegments,
								A2(
									_elm_lang$core$Random$pair,
									_creative$elm_generative$Generative$random(0.5),
									_creative$elm_generative$Generative$random(0.5))))))
			};
		} else {
...
var _creative$elm_generative$Example_Sun$init = A2(_creative$elm_generative$Example_Sun$update, _creative$elm_generative$Example_Sun$Generate, _creative$elm_generative$Example_Sun$Empty);
					...
					do {
						if (_p10.ctor === '_Tuple2') {
							switch (_p10._1.ctor) {
								...
								default:
									if ((_p10._0.ctor === 'SunMsg') && (_p10._1._0.ctor === 'Just')) {
										return A2(
											_elm_lang$core$Tuple$mapSecond,
											_elm_lang$core$Platform_Cmd$map(_creative$elm_generative$Main$SunMsg),
											A2(
												...
												A2(_creative$elm_generative$Example_Sun$update, _p10._0._0, _p10._1._0._0)));
									} else {
										break _v6_4;
									}
							}
